export const activeGame = `<div class="game-container">
...
<div class="active-game">
  ...
  <div class="player player-1 player-turn">
    <h3>Player 1</h3>
    <p class="score p1-score">0</p>
  </div>
  <div class="player player-2">
    <h3>Player 2</h3>
    <p class="score p2-score">1</p>
  </div>
  <div class="player player-3">
    <h3>Player 3</h3>
    <p class="score p3-score">1</p>
  </div>
  <div class="player player-4">
    <h3>Player 4</h3>
    <p class="score p4-score">1</p>
  </div>
</div> -->
  <!-- Multiplayer scores start -->

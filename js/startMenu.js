export const startMenu = `<div class="start-screen">
<svg class="logo-img" width="150" height="28" xmlns="http://www.w3.org/2000/svg">
  <path
    ...
    fill="#152938" fill-rule="nonzero" /></svg>
<div class="start-container">
  <div class="selection-box">
    <h3>Select Theme</h3>
    <div class="selection-buttons">
      <button class="btn btn-mode btn-theme num-theme theme-active">Numbers</button>
      <button class="btn btn-mode btn-theme icon-theme">Icons</button>
    </div>
  </div>
  <div class="selection-box">
    <h3>Number of Players</h3>
    <div class="selection-buttons">
      <button class="btn btn-mode btn-players players-active">1</button>
      <button class="btn btn-mode btn-players">2</button>
      <button class="btn btn-mode btn-players">3</button>
      <button class="btn btn-mode btn-players">4</button>
    </div>
  </div>
  <div class="selection-box">
    <h3>Grid Size</h3>
    <div class="selection-buttons">
      <button class="btn btn-mode btn-grid grid-active">4x4</button>
      <button class="btn btn-mode btn-grid">6x6</button>
    </div>
  </div>
  <button class="btn btn-mode btn-start">Start Game</button>
</div>
</div>`;
...
<div class="start-container">
  <div class="selection-box">
    ...
    <div class="selection-buttons">
      <button class="btn btn-mode btn-theme active">Numbers</button>
      <button class="btn btn-mode btn-theme">Icons</button>
    </div>
  </div>
  <div class="selection-box">
    <h3>Number of Players</h3>
    <div class="selection-buttons">
      <button class="btn btn-mode btn-players active">1</button>
  ...
  <div class="selection-box">
    <h3>Grid Size</h3>
    <div class="selection-buttons">
      <button class="btn btn-mode btn-grid active">4x4</button>
